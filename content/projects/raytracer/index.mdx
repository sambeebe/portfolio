...
#### Raytracer (C++)
[(code)]
(http://github.com/sambeebe/whitted-style-raytracer "code")
...
[(code)]
(http://github.com/sambeebe/ModelLoader-OpenGL "Example")
C++ program that loads a model into OpenGL.
![Alt Text](buddha.png "Image Title")


#### OpenGL Earth Animation (C++)
[(code)]
(http://github.com/sambeebe/Earth-OpenGL "Example")
